      ...
      <div className="container  mx-auto flex px-5 py-16 items-center justify-center flex-col">
        ...
        <div className="text-center lg:w-2/3 w-full ">
          ...
          <div className="flex justify-center animate-pulse">
            <button className="inline-flex text-white bg-red-600 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded-sm text-lg"><a href="https://www.youtube.com/channel/UC9Hg731splneZdAHFhT1Thw" target="_blank"><span>SUBSCRIBE</span></a></button>
